...
def evidence_records() -> dict[str, ExperimentRecord]:
    proposal = PatchProposal(
        ...
        change="Increase warmup from two to five percent of the training budget.",
        expected_effect=0.004,
        minimum_useful_gain=0.001,
        resource_risk="Negligible runtime change.",
        failure_signal="The protected objective is unchanged or worse.",
    ...
    candidate = CandidateRecord(
        ...
        changed_paths=("target/trainer.py",),
        ...
        return ArtifactManifest(
            ...
            artifacts=(
                ArtifactRef(
                    ...
                    kind="checkpoint",
                    relative_path=f"runs/{run.run_id}/checkpoint.bin",
